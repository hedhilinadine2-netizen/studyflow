...
<main class="main">
    ...
    <div class="subject-selector">
        ...
        <a href="add-task.php" style="margin-left: auto; background:#667eea; color:white; padding:8px 20px; border-radius:10px; text-decoration:none; font-size:0.85rem;">+ Add Task</a>
    </div>
...
<script>
    let allTasks = <?php echo json_encode($tasks); ?>;
    ...
    function renderTasks() {
        let filteredTasks = currentFilter === 'current' ? 
