    ...
    <div class="form-container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <textarea name="description" rows="3" placeholder="Add details about this task..."></textarea>
            </div>
